...
class Post
  ...
  # Метод find_all находит в базе массив записей который можно например
  # показать в виде таблицы на экране
  ...
  # Метод find_by_id находит в базе запись по идентификатору, которую можно например
  # показать в виде таблицы на экране
